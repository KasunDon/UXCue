...
- `docs/`: product strategy, research, MVP breakdown, agent stories, data model, UX/UI design, testing, backlog, cloud/infra planning, GitHub/MCP plans, and decision logs.
