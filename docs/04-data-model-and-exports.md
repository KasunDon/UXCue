...
---
Created from UXLens issue `{displayId}`.
````
...
| UXLens field | GitHub label |
| --- | --- |
| any UXLens issue | `uxlens` |
...
If labels do not exist or permission is insufficient, issue creation should still proceed and UXLens should record a warning.
